...
//apis
import { getAllDiets } from "@/app/diet/apis/getAllDiets";
...
export default function List() {
  ...
  const { data, isLoading } = useQuery(
    [queryKey.식단표.리스트, page, search],
    () =>
      getAllDiets({ axiosInstance, page: parsedPage, search: parsedSearch }),
    {
                  ...
                  {data?.results?.map((item: any, i: number) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <TxtSpan size={12} color={colors.grey400}>
                          {item?.created_by} | {item?.views}명 조회 |{" "}
