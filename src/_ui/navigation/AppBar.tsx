...
export const AppBar = forwardRef(
  (
    { children, serviceName, theme = "light", width, ...props }: Props,
      ...
      >
        <header
          ...
          css={{
            ...
            backgroundColor:
              props?.backgroundColor ?? TYPE_VARIANTS[theme].backgroundColor,
            borderBottom:
              props?.borderBottom ?? isActive
                ? `1px solid ${TYPE_VARIANTS[theme].color}`
                : "",
          }}
          {...props}
        >
