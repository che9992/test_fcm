...
const BottomTabNavigatorBase: React.ForwardRefRenderFunction<
  HTMLDivElement,
  Props
> = ({ children, design = "default", maxWidth = 600 }, ref) => {
...
export const BottomNavigator = forwardRef(
  BottomTabNavigatorBase
) as BottomTabNavigatorComponent;

//
//
const Tab = forwardRef<HTMLAnchorElement, MenuProps>(
