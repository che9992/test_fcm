...
interface CheckProps
  ...
  themes?: {
    ...
    label?: {
      ...
      titleWhiteSpace?: "pre-line" | "nowrap" | "normal";
      txtColor?: string;
      txtSize?: number;
    };
  };
      ...
      >
        ...
        <input
          ...
          css={{
            ...
            "&:checked": {
              backgroundColor: checkTheme?.checkColor ?? colors.keyColor,
            },
            "&:disabled": {
        ...
        <V.Column gap={4}>
          <label
            ...
            css={{
              ...
              whiteSpace: themes?.label?.titleWhiteSpace,
            }}
          >
            <Txt
              ...
              css={{ userSelect: "none", whiteSpace: "normal" }}
            >
              {label.title}
            </Txt>
          </label>
